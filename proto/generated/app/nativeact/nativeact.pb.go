...
import (
	middleware "github.com/hebingchang/bilibili-go/proto/generated/app/archive/middleware"
	dynamic_v2 "github.com/hebingchang/bilibili-go/proto/generated/app/dynamic_v2"
...
type DynamicCard struct {
	...
	Dynamic *dynamic_v2.DynamicItem `protobuf:"bytes,1,opt,name=dynamic,proto3" json:"dynamic,omitempty"`
}
...
func (x *DynamicCard) GetDynamic() *dynamic_v2.DynamicItem {
	if x != nil {
		return x.Dynamic
	}
	return nil
...
func (x *DynamicReq) GetPlayerArgs() *middleware.PlayerArgs {
	if x != nil {
		return x.PlayerArgs
	}
	return nil
...
type IndexReq struct {
	...
	PlayerArgs *middleware.PlayerArgs `protobuf:"bytes,10,opt,name=player_args,json=playerArgs,proto3" json:"player_args,omitempty"`
...
func (x *IndexReq) GetPlayerArgs() *middleware.PlayerArgs {
	if x != nil {
		return x.PlayerArgs
	}
	return nil
...
func (x *InlineIndexReq) GetPlayerArgs() *middleware.PlayerArgs {
	if x != nil {
		return x.PlayerArgs
	}
	return nil
...
type LayerDynamic struct {
	...
	Title string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Dynamic *dynamic_v2.DynamicItem `protobuf:"bytes,2,opt,name=dynamic,proto3" json:"dynamic,omitempty"`
}
...
func (x *LayerDynamic) GetDynamic() *dynamic_v2.DynamicItem {
	if x != nil {
		return x.Dynamic
	}
	return nil
...
func (x *TabIndexReq) GetPlayerArgs() *middleware.PlayerArgs {
	if x != nil {
		return x.PlayerArgs
	}
	return nil
...
func (x *TopicIndexReq) GetPlayerArgs() *middleware.PlayerArgs {
	if x != nil {
		return x.PlayerArgs
	}
	return nil
...
var file_bilibili_app_nativeact_v1_nativeact_proto_rawDesc = []byte{
	...
	0x79, 0x6c, 0x65, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x10, 0x02, 0x42, 0x42, 0x5a, 0x40, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x65, 0x62, 0x69, 0x6e, 0x67,
	0x63, 0x68, 0x61, 0x6e, 0x67, 0x2f, 0x62, 0x69, 0x6c, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x2d, 0x67,
	0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
	0x64, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x61, 0x63, 0x74, 0x62,
...
var file_bilibili_app_nativeact_v1_nativeact_proto_goTypes = []interface{}{
	...
	(*dynamic_v2.DynamicItem)(nil),        // 130: bilibili.app.dynamic.v2.DynamicItem
	(*anypb.Any)(nil),                     // 131: google.protobuf.Any
	(*middleware.PlayerArgs)(nil),         // 132: bilibili.app.archive.middleware.v1.PlayerArgs
}
